    ...
    <div class="my-auto">
        ...
        <div class="col-md-12">
            ...
            <div id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <!--div class="card">
                <div class="card-header" role="tab" id="headingThreee">
                    <h5 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#headingThreee" aria-expanded="false" aria-controls="collapseThree">
                        sobra <button class="btn btn-info btnTelasPlasticas"><i class="far fa-images tamImgTelas"></i></button>
                    </a>
                    </h5>
                </div>
                <div id="headingThreee" class="collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div class="card-block">
